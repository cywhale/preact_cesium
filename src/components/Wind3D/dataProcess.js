...
const DataProcess = (function () {
    ...
    var randomizeParticles = function (maxParticles, viewerParameters) {
        ...
        for (var i = 0; i < maxParticles; i++) {
            array[4 * i] = CesiumMath.randomBetween(viewerParameters.lonRange.x, viewerParameters.lonRange.y); //Cesium.
            array[4 * i + 1] = CesiumMath.randomBetween(viewerParameters.latRange.x, viewerParameters.latRange.y); //Cesium.
            array[4 * i + 2] = CesiumMath.randomBetween(data.lev.min, data.lev.max); //Cesium.
            array[4 * i + 3] = 0.0;
        }
        return array;
    }
