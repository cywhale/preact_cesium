...
//export const demo = defaultValue(demo, false); //Cesium.

export const fileOptions = {
    dataDirectory: //demo ? 'https://raw.githubusercontent.com/RaymanNg/3D-Wind-Field/master/data/' : '../data/',
      'https://ecodata.odb.ntu.edu.tw/pub/test/',
    dataFile: "3dwinddemo.nc",
...
const getParticleAttr = () => {
        // make sure maxParticles is exactly the square of particlesTextureSize
    const particlesTextureSize = Math.ceil(Math.sqrt(defaultParticleSystemOptions.maxParticles));
...
// Temporarily added by cywhale
export const userInput = {
        maxParticles: getParticleAttr().maxParticles,
        particlesTextureSize: getParticleAttr().particlesTextureSize,
        particleHeight: defaultParticleSystemOptions.particleHeight,
        fadeOpacity: defaultParticleSystemOptions.fadeOpacity,
        dropRate: defaultParticleSystemOptions.dropRate,
        dropRateBump: defaultParticleSystemOptions.dropRateBump,
        speedFactor: defaultParticleSystemOptions.speedFactor,
        lineWidth: defaultParticleSystemOptions.lineWidth,
